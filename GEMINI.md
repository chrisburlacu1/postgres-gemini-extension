...
- **Data Exploration:** `preview_table`, `global_search`, `profile_column`, `get_entity_graph`
- **Query:** `execute_query`
- **Schema Discovery:** `get_schema_overview`, `list_databases`, `list_schemas`, `list_tables`, `list_views`, `describe_table`, `get_table_ddl`, `search_schema`, `get_database_schema_erd`, `get_table_relationships`, `find_join_path`, `clear_cache`
