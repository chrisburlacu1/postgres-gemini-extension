...
- **Query:** `execute_query`
- **Schema Discovery:** `list_databases`, `list_schemas`, `list_tables`, `list_views`, `describe_table`, `search_schema`, `get_database_schema_erd`, `get_table_relationships`, `find_join_path`, `clear_cache`
